...
<div class="container-fluid">
	<form  id="manage-files" method='post' action='' enctype="multipart/form-data">
	...
	<?php endif; ?>
		...
		<div class="form-group">
			<label for="is_public" class="control-label"><input type="checkbox" name="is_public" id="is_public"><i> Share to All Users
			</i></label>
		</div>
		<div class="form-group" id="msg"><input type='' value=''></div>
...
<script>
	$(document).ready(function(){
		...
		$('#msg').html('')
		$.ajax({
			url:'../fms_2/ajax.php?action=save_files',
