    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar">
      <div class="container-fluid">
        ...
        <a class="navbar-brand waves-effect" href="#">
          ...
          <strong class="blue-text">of the office of
          <font color="#F0B56F">SSG</font>
Kaduna State Government, Kaduna</strong>
        </a>
 ...
 <div id="loader"></div>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav nav-flex-icons">
                     <li class="">
              <a href="#" class="list-group-item list-group-item-action waves-effect"  data-toggle="modal" data-target="#modalRegisterForm">
          <i class="fas fa-user mr-3"></i>Add Admin2</a>
          </li>
            <li class="">
          <a href="dashboard.php" class="list-group-item list-group-item-action waves-effect"><span class='icon-field'><i class="fa fa-home"></i></span> Home2</a>
          </li>
          </ul>
    </div>
...
$query=mysqli_query($conn,"SELECT *,count(DISTINCT user_id) AS unique_user FROM files GROUP BY id,user_id ORDER BY unique_user DESC")or die(mysqli_error($conn));
  ...
  <script>
    ...
    var myPieChart = new Chart(ctxP, {
      type: 'pie',
      data: {
        labels: ["Red", "Green", "Yellow", "blue", "Dark Grey"],
        datasets: [{
