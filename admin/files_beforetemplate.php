		...
		<div class="row">
			<div class="card col-md-12">
				<div class="card-body">
					...
					<?php
					if($myrowid>0){
					print"<tr><td align='right' colspan='3' ><button class='btn btn-primary btn-sm' id='Add_viewers_folder'><i class='fas fa-file-medical'></i>  Add Viewers</button>
					<button class='btn btn-primary btn-sm' id='send_viewers_folder'><i class='fas fa-file-medical'></i>Send Files</button></td></tr>";
