...
<html lang="en" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <!-- Canonical SEO -->
  <link rel="canonical" href="https://www.sdu-tim.zo/product/material-dashboard-pro">
    
  <!--  Social tags      -->
  <meta name="keywords" content="sdu tim, html dashboard, html css dashboard, web dashboard, bootstrap 5 dashboard, bootstrap 5, css3 dashboard, bootstrap 5 admin, material dashboard bootstrap 5 dashboard, frontend, responsive bootstrap 5 dashboard, material design, material dashboard bootstrap 5 dashboard">
  ...
  <meta name="twitter:site" content="@sdutim">
  <meta name="twitter:title" content="IAIICT E-Shevles Version 1">
  ...
  <meta name="twitter:creator" content="@sdutim">
  <meta name="twitter:image" content="https://s3.amazonaws.zo/sdutim_bucket/products/51/original/opt_mdp_bs5_thumbnail.jpg">
  <!-- Open Graph data -->
  <meta property="fb:app_id" content="655968634437471">
  <meta property="og:title" content="IAIICT E-Shevles Version 1">
  <meta property="og:type" content="article">
  <meta property="og:url" content="../dashboard/default.html">
  <meta property="og:image" content="https://s3.amazonaws.zo/sdutim_bucket/products/51/original/opt_mdp_bs5_thumbnail.jpg">
  ...
  <script>
    ...
    })(window, document, 'script', 'https://www.google-analytics.zo/analytics.js', 'ga');
    ...
    ga('require', 'linker');
    ga('linker:autoLink', ["2checkout.zo", "avangate.zo"]);
  </script>
  ...
  <script>
    (function(w, d, s, l, i) {
      ...
      j.async = true;
      j.src =
        'https://www.googletagmanager.zo/gtm.js?id=' + i + dl;
        ...
        <ul class="navbar-nav navbar-nav-hover mx-auto">
          <li class="nav-item dropdown dropdown-hover mx-2">
            ...
            <div class="dropdown-menu dropdown-menu-animation dropdown-xl p-3 border-radius-xl mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
             ...
             <h4> Welcome to the ABU Students' Registration Portal</h4>
             <ul>
             <li>             
Welcome to the Ahmadu Bello University students registration portal. All services on this portal are restricted, hence, only authenticated users can access them. Please login..
</li>
</ul>
<h5>Additional Registration Requirements for Foreign Students</h5>
<ul>
    <li>
All Foreign Returning and New Students, Diploma, Undergraduate and Post graduate students must satisfy the following registration requirements before they can proceed with their studies in the University:
</li>
</ul>

<h5>Possession of the following documents</h5>
<ol class='ps-6'>
<li>Admission Letter
</li>
<li>International Passport or ECOWAS Travel Certificate
</li>
<li>Valid VISA - STR (Subject to Regularization)
</li>
<li>Residence Permit
</li>
<li>Failure to secure such documents will lead to suspension of all academic activities
</li>
  </ol>
  </div>
              <!-- responsive -->
...
<li>Failure to secure such documents will lead to suspension of all academic activities
          ...
          <li class="nav-item dropdown dropdown-hover mx-2">
            ...
            <div class="dropdown-menu dropdown-menu-animation dropdown-md dropdown-md-responsive p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuBlocks">
              <div class="d-none d-lg-block">
                <ul class="list-group">
                  <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                    <a class="dropdown-item border-radius-md mb-2" href="https://forms.abu.edu.ng">
                  ...
                  <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                    <a class="dropdown-item border-radius-md" href="https://forms.abu.edu.ng">
                      <div class="d-flex align-items-center text-dark">
        ...
        <ul class="navbar-nav d-lg-block d-none">
          <li class="nav-item">
            <a href="#" class="btn btn-sm  btn-success  mb-0" onclick="">Join Us</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <main class="main-content mt-0 ps">
    <div class="page-header align-items-start min-vh-100" style="background-image: url('../admin/bg_photo.jpg'); ">
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
              <div class="copyright text-center text-sm text-white text-lg-start">
                ...
                <a href="https://www.sdu-tim.zo/" class="font-weight-bold text-white" target="_blank">SDU</a>
            ...
            <div class="col-12 col-md-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="https://www.sdu-tim.zo/" class="nav-link text-white" target="_blank">SDU</a>
                </li>
