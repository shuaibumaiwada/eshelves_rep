<!DOCTYPE html>
<!-- saved from url=(0092)../authentication/signin/basic.html -->
<html lang="en" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <meta property="og:url" content="../dashboard/default.html">
...
}</style><meta http-equiv="origin-trial" content=""></head>

<body class="bg-gray-200"><div id="ofBar" style="display:none"><div id="ofBar-logo"> <img alt="creative-tim-logo" src=""></div><div id="ofBar-content">🔥🔥🔥 <b> Winter Sale 2024</b>: Join Creative Tim Club Today &amp; <b>Get 45% OFF</b>! ✨</div><div id="ofBar-right"><a href="https://www.creative-tim.com/club?ref=ct-demos" target="_blank" id="btn-bar">View Offer</a><a id="close-bar">×</a></div></div><!-- Extra details for Live View on GitHub Pages --><!-- Google Tag Manager (noscript) -->

  <!-- End Google Tag Manager (noscript) -->
  <!-- Navbar -->
  <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent mt-4">
    <div class="container">
      <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="../dashboard/analytics.html">
        IAIICT E-Shelves Version 1
      </a>
      ...
      <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
        <ul class="navbar-nav navbar-nav-hover mx-auto">
          <li class="nav-item dropdown dropdown-hover mx-2">
            ...
            <div class="dropdown-menu dropdown-menu-animation dropdown-xl p-3 border-radius-xl mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                ...
                <div class="col-12 px-4 py-2">
                  <div class="row">
                    <div class="col-4 position-relative">
                      ...
                      <a href="../dashboard/analytics.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Analytics</span>
                      </a>
                      <a href="../dashboard/discover.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Discover</span>
                      </a>
                      <a href="../dashboard/sales.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Sales</span>
                      </a>
                      <a href="../dashboard/automotive.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Automotive</span>
                      </a>
                      <a href="../dashboard/smart-home.html" class="dropdown-item border-radius-md">
                      ...
                      <div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">people</i>
                        Users
                      </div>
                      <a href="../users/reports.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Reports</span>
                      </a>
                      <a href="../users/new-user.html" class="dropdown-item border-radius-md">
                    ...
                    <div class="col-4 position-relative">
                      ...
                      <a href="../profile/overview.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Overview</span>
                      </a>
                      <a href="../profile/messages.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Messages</span>
                      </a>
                      <a href="../profile/projects.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Projects</span>
                      </a>
                      <div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">precision_manufacturing</i>
                        Projects
                      </div>
                      <a href="../projects/general.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">General</span>
                      </a>
                      <a href="../projects/timeline.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Timeline</span>
                      </a>
                      <a href="../vr/vr-default.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Virtual Reality</span>
                      </a>
                      <a href="../projects/new-project.html" class="dropdown-item border-radius-md">
                    ...
                    <div class="col-4">
                      <div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-0">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">account_balance</i>
                        Account
                      </div>
                      <a href="../account/settings.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Settings</span>
                      </a>
                      <a href="../account/billing.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Billing</span>
                      </a>
                      <a href="../account/invoice.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Invoice</span>
                      </a>
                      <a href="../account/security.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Security</span>
                      </a>
                      <div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-0 mt-3">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">queue_play_next</i>
                        Extra
                      </div>
                      <a href="../pricing-page.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Pricing Page</span>
                      </a>
                      <a href="../rtl-page.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">RTL Page</span>
                      </a>
                      <a href="../widgets.html" class="dropdown-item border-radius-md">
              ...
              <div class="d-lg-none">
                <div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-0">
                  <i class="material-symbols-rounded text-dark opacity-6 me-2 text-md">dashboard</i>
                  Dashboards
                </div>
                <a href="../dashboard/analytics.html" class="dropdown-item border-radius-md">
                  Analytics
                ...
                <div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-0 mt-3">
                  <i class="material-symbols-rounded text-dark opacity-6 me-2 text-md">people</i>
                  Users
                </div>
                <a href="../users/reports.html" class="dropdown-item border-radius-md">
                  Reports
                ...
                <div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-0 mt-3">
                  <i class="material-symbols-rounded text-dark opacity-6 me-2 text-md">badge</i>
                  Profile
                </div>
                <a href="../profile/overview.html" class="dropdown-item border-radius-md">
                  Overview
                ...
                <div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                  <i class="material-symbols-rounded text-dark opacity-6 me-2 text-md">precision_manufacturing</i>
                  Projects
                </div>
                <a href="../projects/general.html" class="dropdown-item border-radius-md">
                  General
                ...
                <div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                  <i class="material-symbols-rounded text-dark opacity-6 me-2 text-md">account_balance</i>
                  Account
                </div>
                <a href="../account/settings.html" class="dropdown-item border-radius-md">
                  Settings
                ...
                <div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                  <i class="material-symbols-rounded text-dark opacity-6 me-2 text-md">queue_play_next</i>
                  Extra
                </div>
                <a href="../pricing-page.html" class="dropdown-item border-radius-md">
                  Pricing Page
            ...
            <div class="dropdown-menu dropdown-menu-animation dropdown-md border-radius-xl p-3 mt-0 mt-lg-3" aria-labelledby="dropdownMenuAccount">
                  ...
                  <ul class="list-group">
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                      ...
                      <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownSignIn">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/signin/basic.html">
                          <span>Basic</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/signin/cover.html">
                          <span>Cover</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md" href="../authentication/signin/illustration.html">
                    ...
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                      ...
                      <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownSignUp">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/signup/basic.html">
                          <span>Basic</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/signup/cover.html">
                          <span>Cover</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md" href="../authentication/signup/illustration.html">
                          <span>Illustration</span>
                        </a>
                      </div>
                    </li>
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                      ...
                      <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownPasswordReset">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/reset/basic.html">
                          <span>Basic</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/reset/cover.html">
                          <span>Cover</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md" href="../authentication/reset/illustration.html">
                          <span>Illustration</span>
                        </a>
                      </div>
                    </li>
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                      <a class="dropdown-item border-radius-md ps-3 d-flex align-items-center mb-1 text-dark" id="dropdownLock">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">lock</i>
                        <span>Lock</span>
                        <img src="./admindash_sales/down-arrow.svg" alt="down-arrow" class="arrow ms-auto">
                      </a>
                      <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownLock">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/lock/basic.html">
                          <span>Basic</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/lock/cover.html">
                          <span>Cover</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md" href="../authentication/lock/illustration.html">
                          <span>Illustration</span>
                        </a>
                      </div>
                    </li>
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                      <a class="dropdown-item border-radius-md ps-3 d-flex align-items-center mb-1 text-dark" id="dropdown2fa">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">admin_panel_settings</i>
                        <span>2-Step Verification</span>
                        <img src="./admindash_sales/down-arrow.svg" alt="down-arrow" class="arrow ms-auto">
                      </a>
                      <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdown2fa">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/verification/basic.html">
                          <span>Basic</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/verification/cover.html">
                          <span>Cover</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md" href="../authentication/verification/illustration.html">
                          <span>Illustration</span>
                        </a>
                      </div>
                    </li>
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                      <a class="dropdown-item border-radius-md ps-3 d-flex align-items-center mb-1 text-dark" id="dropdownError">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">warning</i>
                        <span>Error</span>
                        <img src="./admindash_sales/down-arrow.svg" alt="down-arrow" class="arrow ms-auto">
                      </a>
                      <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownError">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="../authentication/error/404.html">
                          <span>404</span>
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md" href="../authentication/error/500.html">
                          <span>500</span>
                        </a>
                      </div>
                    </li>
              ...
              <div class="row d-lg-none">
                <div class="col-12 d-flex justify-content-center flex-column">
                  ...
                  <a href="../authentication/signin/basic.html" class="dropdown-item border-radius-md ps-4">
                    Basic
                  </a>
                  <a href="../authentication/signin/cover.html" class="dropdown-item border-radius-md ps-4">
                    Cover
                  </a>
                  <a href="../authentication/signin/illustration.html" class="dropdown-item border-radius-md ps-4">
                    Illustration
                  </a>
                  ...
                  <a href="../authentication/signup/basic.html" class="dropdown-item border-radius-md ps-4">
                    Basic
                  </a>
                  <a href="../authentication/signup/cover.html" class="dropdown-item border-radius-md ps-4">
                    Cover
                  </a>
                  <a href="../authentication/signup/illustration.html" class="dropdown-item border-radius-md ps-4">
                    Illustration
                  </a>
                  <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                    <i class="material-symbols-rounded opacity-6 me-2 text-md">restart_alt</i>
                  ...
                  <a href="../authentication/reset/basic.html" class="dropdown-item border-radius-md ps-4">
                    Basic
                  </a>
                  <a href="../authentication/reset/cover.html" class="dropdown-item border-radius-md ps-4">
                    Cover
                  </a>
                  <a href="../authentication/reset/illustration.html" class="dropdown-item border-radius-md ps-4">
                    Illustation
                  </a>
                  <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                    <i class="material-symbols-rounded opacity-6 me-2 text-md">lock</i>
                  ...
                  <a href="../authentication/lock/basic.html" class="dropdown-item border-radius-md ps-4">
                    Basic
                  </a>
                  <a href="../authentication/lock/cover.html" class="dropdown-item border-radius-md ps-4">
                    Cover
                  </a>
                  <a href="../authentication/lock/illustration.html" class="dropdown-item border-radius-md ps-4">
                    Illustration
                  </a>
                  <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                    <i class="material-symbols-rounded opacity-6 me-2 text-md">admin_panel_settings</i>
                  ...
                  <a href="../authentication/verification/basic.html" class="dropdown-item border-radius-md ps-4">
                    Basic
                  </a>
                  <a href="../authentication/verification/cover.html" class="dropdown-item border-radius-md ps-4">
                    Cover
                  </a>
                  <a href="../authentication/verification/illustration.html" class="dropdown-item border-radius-md ps-4">
                    Illustration
                  </a>
                  <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                    <i class="material-symbols-rounded opacity-6 me-2 text-md">warning</i>
                  ...
                  <a href="../authentication/error/404.html" class="dropdown-item border-radius-md ps-4">
                    404
                  </a>
                  <a href="../authentication/error/500.html" class="dropdown-item border-radius-md ps-4">
                    500
                  </a>
                </div>
              </div>
          ...
          <li class="nav-item dropdown dropdown-hover mx-2">
            ...
            <div class="dropdown-menu dropdown-menu-animation dropdown-md dropdown-md-responsive p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuBlocks">
              <div class="d-none d-lg-block">
                <ul class="list-group">
                  <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                    <a class="dropdown-item border-radius-md mb-2" href="../applications/kanban.html">
                      <div class="d-flex align-items-center text-dark">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">widgets</i>
                        Kanban
                      </div>
                    </a>
                  </li>
                  <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                    <a class="dropdown-item border-radius-md mb-2" href="../applications/wizard.html">
                      <div class="d-flex align-items-center text-dark">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">import_contacts</i>
                        Wizard
                      </div>
                    </a>
                  </li>
                  <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                    <a class="dropdown-item border-radius-md mb-2" href="../applications/datatables.html">
                      <div class="d-flex align-items-center text-dark">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">backup_table</i>
                        DataTables
                      </div>
                    </a>
                  </li>
                  <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                    <a class="dropdown-item border-radius-md" href="../applications/calendar.html">
                      <div class="d-flex align-items-center text-dark">
              ...
              <div class="row d-lg-none">
                <div class="col-md-12">
                  <a class="py-2 ps-3 border-radius-md" href="../applications/kanban.html">
                    <div class="d-flex align-items-center text-dark">
                      <i class="material-symbols-rounded opacity-6 me-2 text-md">widgets</i>
                      Kanban
                    </div>
                  </a>
                  <a class="py-2 ps-3 border-radius-md" href="../applications/wizard.html">
                    <div class="d-flex align-items-center text-dark">
                      <i class="material-symbols-rounded opacity-6 me-2 text-md">import_contacts</i>
                      Wizard
                    </div>
                  </a>
                  <a class="py-2 ps-3 border-radius-md" href="../applications/datatables.html">
                    <div class="d-flex align-items-center text-dark">
                      <i class="material-symbols-rounded opacity-6 me-2 text-md">backup_table</i>
                      DataTables
                    </div>
                  </a>
                  <a class="py-2 ps-3 border-radius-md" href="../applications/calendar.html">
                    <div class="d-flex align-items-center text-dark">
                      <i class="material-symbols-rounded opacity-6 me-2 text-md">event</i>
                      Calendar
                    </div>
          ...
          <li class="nav-item dropdown dropdown-hover mx-2">
            ...
            <div class="dropdown-menu dropdown-menu-animation dropdown-lg p-3 border-radius-xl mt-0 mt-lg-3" aria-labelledby="dropdownMenuEcommerce">
                ...
                <div class="col-12 px-4 py-2">
                  <div class="row">
                    <div class="col-6 position-relative">
                      <div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-0">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">shopping_cart</i>
                        Orders
                      </div>
                      <a href="../ecommerce/orders/list.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Order List</span>
                      </a>
                      <a href="../ecommerce/orders/details.html" class="dropdown-item border-radius-md">
                      ...
                      <a href="../ecommerce/overview.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Overview</span>
                      </a>
                      <a href="../ecommerce/referral.html" class="dropdown-item border-radius-md">
                    ...
                    <div class="col-6 position-relative">
                      <div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-0">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">memory</i>
                        Products
                      </div>
                      <a href="../ecommerce/products/new-product.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">New Product</span>
                      </a>
                      <a href="../ecommerce/products/edit-product.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Edit Product</span>
                      </a>
                      <a href="../ecommerce/products/product-page.html" class="dropdown-item border-radius-md">
                        <span class="ps-2">Product Page</span>
                      </a>
                      <a href="../ecommerce/products/products-list.html" class="dropdown-item border-radius-md">
              ...
              <div class="d-lg-none">
                ...
                <a href="../orders/details.html" class="dropdown-item border-radius-md">
                  Order Details
                </a>
                <div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-0 mt-3">
                  <i class="material-symbols-rounded opacity-6 me-2 text-md">store</i>
            ...
            <div class="dropdown-menu dropdown-menu-animation dropdown-lg mt-0 mt-lg-3 p-3 border-radius-lg" aria-labelledby="dropdownMenuDocs">
                ...
                <ul class="list-group">
                  ...
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item border-radius-md text-dark" href="https://www.creative-tim.com/learning-lab/bootstrap/colors/material-dashboard">
                      <div class="d-flex align-items-center">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">grading</i>
                  ...
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item border-radius-md text-dark" href="https://www.creative-tim.com/learning-lab/bootstrap/alerts/material-dashboard">
                      <div class="d-flex align-items-center">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">apps</i>
                  ...
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item border-radius-md text-dark" href="https://www.creative-tim.com/learning-lab/bootstrap/datepicker/material-dashboard">
                      <div class="d-flex align-items-center">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">extension</i>
                  ...
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item border-radius-md text-dark" href="https://www.creative-tim.com/learning-lab/bootstrap/utilities/material-dashboard">
                      <div class="d-flex align-items-center">
                        <i class="material-symbols-rounded opacity-6 me-2 text-md">swipe</i>
              ...
              <div class="row d-lg-none">
                <div class="col-md-12 g-0">
                  <a class="dropdown-item border-radius-md text-dark" href="../about-us.html">
                    <div class="d-flex align-items-center">
                      <i class="material-symbols-rounded opacity-6 me-2 text-md">article</i>
        ...
        <ul class="navbar-nav d-lg-block d-none">
          <li class="nav-item">
            <a href="#" class="btn btn-sm  bg-gradient-primary  mb-0" onclick="smoothToPricing(&#39;pricing-soft-ui&#39;)">Join Us</a>
          </li>
        </ul>
      </div>
    </div>
              ...
              <div class="card-body">
                <form role="form" class="text-start" action="admin_login.php" method="post">
                  ...
                  <div class="form-check form-switch d-flex align-items-center mb-3">
                    ...
                    <label class="form-check-label mb-0 ms-3" for="rememberMe">Remember meee</label>
                  </div>
                  <div class="text-center">
                    <button class="btn bg-gradient-dark w-100 my-4 mb-2" name = "adminlog" id="login" type="submit">Log In</button>
                  </div>
                  <p class="mt-4 text-sm text-center">
                    Don't have an account?
                    <a href="../authentication/signup/illustration.html" class="text-primary text-gradient font-weight-bold">Sign up</a>
                  </p>
                </form>
              </div>
            </div>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
              <div class="copyright text-center text-sm text-white text-lg-start">
                ...
                <a href="https://www.creative-tim.com/" class="font-weight-bold text-white" target="_blank">SDU</a>
                for the Files Management.
              </div>
            </div>
            <div class="col-12 col-md-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="https://www.creative-tim.com/" class="nav-link text-white" target="_blank">SDU</a>
                </li>
            
             
                <li class="nav-item">
                  <a href="#" class="nav-link pe-0 text-white" target="_blank">More infotmation...</a>
                </li>
              </ul>
            </div>
          </div>
