            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse  show " id="dashboardsExamples">
                        <ul class="nav ">
                            <li class="nav-item ">
                                <a class="nav-link text-dark " href="add_document.php?userid=">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse " id="pagesExamples">
                        <ul class="nav ">
                            <li class="nav-item ">
                                <a data-bs-toggle="collapse" aria-expanded="false" href="#" class="nav-link text-dark"
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card mb-4 wow fadeIn">
                        ...
                        <!--Card content-->
                        <div> <?php include('files.php'); ?>
                        </div>
                        <div class="" style='display:none;'>

                            <a href="add_file.php"><button type="button" class="btn btn-success"><i
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h6>Main Folders on the Desk </h6>
                        </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-3 py-1">
                                                    <div>
                                                        <i class="fa fa-folder d-flex px-3 py-1"></i>
                                                    </div>
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">Movement Folder</h6>
                                                        <p class="text-sm font-weight-normal text-secondary mb-0"><span
                                                                class="text-success">8</span> Records</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-normal mb-0">992</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-sm font-weight-normal mb-0">Active</p>
                                            </td>
                                            <td class="align-middle text-end">
                                                <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                                    <p class="text-sm font-weight-normal mb-0">13-12-2024</p>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-3 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">Business Folder</h6>
                                                        <p class="text-sm font-weight-normal text-secondary mb-0"><span
                                                                class="text-success">18</span> Records</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-normal mb-0">250</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-sm font-weight-normal mb-0">Acitve</p>
                                            </td>
                                            <td class="align-middle text-end">
                                                <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                                    <p class="text-sm font-weight-normal mb-0">13-12-2024</p>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-3 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">Result Folder</h6>
                                                        <p class="text-sm font-weight-normal text-secondary mb-0"><span
                                                                class="text-success">12</span> Records</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="text-sm font-weight-normal mb-0">100</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-sm font-weight-normal mb-0">Active</p>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-3 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">Secret Folder</h6>
                                                        <p class="text-sm font-weight-normal text-secondary mb-0"><span
                                                                class="text-success">8</span> Records</p>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-3 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">Office Folder</h6>
                                                        <p class="text-sm font-weight-normal text-secondary mb-0"><span
                                                                class="text-success">28</span> Records</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
