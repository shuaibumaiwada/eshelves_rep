...
<!--Navbar -->
<nav class="mb-1 navbar navbar-expand-lg navbar-dark  lighten-1" style='background-color:#004;'>
    <a class="navbar-brand" href="index.php"><img src="js/img/Files_Download.png" width="33px" height="33px"><font color="##74e874">A</font>hmadu Bello <font color="##74e874">U</font>niversity  <font color="##74e874">D</font>ocument <font color="#74e874">M</font>anagement <font color="#74e874">S</font>ystem</a>
 ...
 <div id="loader"></div>
    ...
    <div class="card-body">
        ...
        <form action="admin_login.php" method="POST">
            <p class="h4 text-center py-4">ADMIN LOGIN</p>
...
<!-- Card --></div>
       <footer class="text-center py-4 mt-3" style="background-color:#005; margin-left: 30%;margin-right: 30%;border-radius:4px;    margin-bottom: 5px; color: #fff;">
                <p>All right Reserved &copy; <? echo $yr; ?> Created By:SDU</p>
            </footer>
<!-- Card -->
  <!-- /Start your project here-->
